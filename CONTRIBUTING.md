...
**There is no CLA to sign.** Opening a pull request against this repository
licenses your contribution under the project's [MIT licence](LICENSE), and
you keep the copyright in your own work — that is GitHub's Terms of Service
(section D.6), and it is all this project asks for.
