...
class TestEnvironment:
    ...
    def test_environment_api_key_unique(self):
        """Test that api_key is unique."""
        env1 = Environment.objects.create(name="Env1", key="env1")
        env2 = Environment.objects.create(name="Env2", key="env2")
        assert env1.api_key != env2.api_key

    def test_environment_key_unique_together(self):
        """Test that key is unique per environment."""
        Environment.objects.create(name="Env1", key="env1")
        with pytest.raises(IntegrityError):
            Environment.objects.create(name="Env2", key="env1")

    def test_environment_str(self):
        """Test environment string representation."""
        env = Environment.objects.create(name="Production", key="prod")
        assert str(env) == "Production"

    def test_environment_api_key_auto_generated(self):
        """Test that api_key is auto-generated if not provided."""
        env = Environment.objects.create(name="Test", key="test")
        assert env.api_key is not None
...
class TestFeatureFlag:
    ...
    def test_feature_flag_unique_together(self):
    ...
    def test_feature_flag_str(self):
    ...
    def test_feature_flag_multivariate_type(self):
...
class TestStrategyRule:
    ...
    def test_strategy_rule_cascade_delete(self):
    ...
    def test_strategy_rule_str(self):
    ...
    def test_strategy_rule_ordering(self):
...
class TestCondition:
    ...
    def test_condition_cascade_delete(self):
...
class TestFlagOverride:
    ...
    def test_flag_override_str(self):
    ...
    def test_flag_override_cascade_delete(self):
